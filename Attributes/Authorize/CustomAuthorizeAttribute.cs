...
namespace RestaurentProjectCore21.Attributes.Authorize
{
    ...
    public class CustomAuthorizeAttribute : AuthorizeAttribute, IAuthorizationFilter
    {
        ...
        {
            var contextOptions = new DbContextOptionsBuilder<ApplicationDbContext>().UseSqlServer(@"Server=(localdb)\mssqllocaldb;Database=RestDBPro").Options;
