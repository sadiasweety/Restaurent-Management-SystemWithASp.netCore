using RestaurentProjectCore21.Attributes.Authorize;
using RestaurentProjectCore21.Data;
using RestaurentProjectCore21.Models;
using RestaurentProjectCore21.ViewModels.NewViewModel;
...
namespace RestaurentProjectCore21.Controllers
{
    [Authorize]
    public class ViewModel : Controller
    {
        ...
        {
            ViewData["AddOrEdit"] = RolesForMenu.GetMenu(User.Identity.Name, "ViewModel", "AddOrEdit");        
        ...
        [HttpPost,HttpGet]
        [ValidateAntiForgeryToken]
        [CustomAuthorize("ViewModel", "AddOrEdit")]
